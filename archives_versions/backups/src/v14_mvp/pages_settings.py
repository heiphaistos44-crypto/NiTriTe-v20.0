...
class SettingsPage(ctk.CTkFrame):
    ...
    def _on_theme_change(self, value):
        ...
        if ThemePalettes.save_theme(value):
            ...
            messagebox.showinfo(
                ...
                f"⚠️ Veuillez redémarrer l'application pour appliquer le nouveau thème.\n\n"
        ...
        if value in mode_map:
            ...
            try:
                ...
                messagebox.showinfo(
                    ...
                    f"⚠️ Veuillez redémarrer l'application pour que\n"
    ...
    def _on_font_size_change(self, value):
        ...
        messagebox.showinfo(
            ...
            f"⚠️ Cette fonctionnalité sera disponible dans une prochaine version.\n"
    ...
    def _reset_config(self):
        ...
        response = messagebox.askyesno(
            ...
            "⚠️ Êtes-vous sûr de vouloir réinitialiser la configuration?\n\n"
